...
$sendPassword_subject = 'Recordatorio de clave http://'. $_SERVER['HTTP_HOST'];
...
$changePassword_subject = 'Ha cambiado su clave en http://'. $_SERVER['HTTP_HOST'];
$changePassword_text = "Ha establecido su nueva clave a: [USER_PASSWORD]\n\n".
                       "Ingrese al portal mediante el siguiente enlace: [DOMAIN]\n\n";

$approve_subject = 'Su registro en http://'. $_SERVER['HTTP_HOST'] .' ha sido aprobado';
$approve_text =
      ...
      "clave: [USER_PASSWORD]\n\n".
      "Ingrese al portal mediante el siguiente enlace: [DOMAIN]\n".
	  "Tambien puede ingresar al foro de la comunidad: http://openehr.org.es/foro \n\n".
      "Por cualquier consulta: [ADMIN_EMAIL]";

// Correo al admin cuando un usuario se registra
$register_subject = 'Se ha registrado un nuevo usuario en http://'. $_SERVER['HTTP_HOST'];
$register_text =
