...
//      echo '</textarea>';
      ...
      // FIXME: pueden venir varios headers Set-Cookie en el response.
      // FIXME: esto es para el response, no para el request
      if (isset($responseHeaders['Set-Cookie']))
      {
         $this->setCookie($responseHeaders['Set-Cookie']);
      }
      ...
      {
         $this->content_type = $responseHeaders['Content-Type'];
      }
