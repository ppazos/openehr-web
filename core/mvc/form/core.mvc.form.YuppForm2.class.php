...
class YuppForm2
{
    ...
    *   - string  controller: 
    *   - string  action: 
    *   - boolean isAjax: indica si al enviar el formulario se utiliza  o no.
    *   - string  Callback: nombre de la funcion javascript que es invocada cuando el
    *                           formulario termina de ser enviado via , solo tiene
    *                           sentido darle un valor si $is es true.
    *
    */
   //public function __construct($app, $controller, $action, $is = false, $Callback = '')
