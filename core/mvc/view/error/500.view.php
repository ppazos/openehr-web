...
function getOutput($m, $plain = false)
{
   ob_start();
   ...
   echo $m->get('message'), $br, $br;
   
   if ($plain)
   {
      echo $m->get('traceString'), $br, $br;
      echo '------------- Codigo donde se dio el error -------------', $br;
   }
   else
   {
      echo '<pre>', $m->get('traceString'), '</pre>';
      echo '<div class="code">';
   }
