			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						...
						<p class="actions"><?php /*<span><a href="register.php" tabindex="5"><?php echo $lang_login['Not registered'] ?></a></span> <span><a href="login.php?action=forget" tabindex="6"><?php echo $lang_login['Forgotten pass'] ?></a></span> */ ?></p>
					</div>
				</fieldset>
			</div>
